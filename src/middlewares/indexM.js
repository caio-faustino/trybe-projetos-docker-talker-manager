...
// Define uma função chamada 'autenticacao' que recebe três parâmetros: um objeto 
...
// Define uma função chamada 'verificarIdade' que recebe três parâmetros: um objeto 'req' 
// contendo o corpo da requisição, um objeto 'res' representando a resposta e a função 
// 'next' que chama o próximo middleware
...
// Define uma função chamada 'verificarTalk' que recebe três parâmetros: um objeto 'req' 
// contendo o corpo da requisição, um objeto 'res' representando a resposta e a função 
// 'next' que chama o próximo middleware
